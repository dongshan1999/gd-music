...
const MUSIC_APP_PLUGIN_CONTROLLER := "res://scripts/ui/music_app/controllers/music_app_plugin_controller.gd"
...
const MUSIC_APP_PLAYBACK_QUEUE_VIEW := "res://scripts/ui/music_app/views/playback_queue/music_app_playback_queue_view.gd"
